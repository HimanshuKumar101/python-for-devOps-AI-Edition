...
class LogAnalyzer: # creating class
    ...
    """
    def __init__(self,file_name,output_file): # init method / constructor are called automatically
        self.file_name = file_name  # self refers to current object 
    ...
    def analyze(self):
        # pdb.set_trace()  # debugging tool  #break point
        log_count = {
            "INFO": 0,
            "WARNING":0,
            "ERROR":0
